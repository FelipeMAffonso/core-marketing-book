...
5. **Add the student's work underneath.** Press Enter twice to make space, then paste the student's full submission, including their five-decision map, their judgment pass, and their AI transcript, right below the instructions, in the same message.
...
7. **Read the score and decide.** The AI's score is a **first draft for you to approve, change, or override.** You are the grader of record. If a score looks off, trust your own read, the grading guide (`ch02-five-decisions-grading-guide.md`) tells you what each row is really worth.
...
> - Marketing is five decisions that all have to agree: **(1) what to make, (2) who to serve, (3) what to charge, (4) where to sell it, (5) how to talk about it.**
> - The decisions **multiply, they do not add.** One weak decision sinks the other four. So naming the single decision that would break the rest is the key insight, not grading the brand "four out of five."
> - A good **positioning statement** names a real buyer and one benefit: *for [a buyer] who [wants something], [brand] is the [kind of product] that [delivers one benefit].* "For everyone" or "high quality" is filler, not a real choice.
> - The assignment's heart is the **judgment pass**: the student should verify some of the AI's lines against the real brand, catch at least one line the AI **guessed or invented** (a wrong price, a competitor that does not compete, a feature the brand lacks), and correct it. AI states guesses as confidently as facts, so catching one is the skill being tested.
>
...
>
> 1. **Judgment pass: knew vs. guessed (30 points).** Did the student verify two or more of the AI's lines against the real brand, AND catch and correct at least one line the AI guessed or invented? Full marks: clear verification plus a named, corrected AI error. Low marks: took the AI output at face value with no checking, or only generated and never judged.
> 2. **The five-decision map (22 points).** Are all five decisions named and filled with specific, verified detail (a real price, a real channel, a real buyer), not generic filler? Deduct for merged, missing, or vague slots ("good product, fair price").
> 3. **The decision that breaks the rest (20 points).** Did the student name the single decision that, if it changed, would break the other four (or two decisions that already contradict each other), and explain the knock-on effect? Low marks if they note a weak slot without explaining what it drags down, or list "improvements" instead of finding the conflict.
> 4. **Positioning and exchange (16 points).** Does the one-line positioning name a real buyer and one benefit (not "everyone," not "high quality")? Does the student show why the trade is worth it to that buyer? Deduct for filler any rival could copy.
> 5. **Takeaway and writing (12 points).** Is there one clear sentence on what holds the brand together or what will break it, in plain language with correct use of the chapter's terms?
>
> **Watch for these failure patterns and score them down (with a kind note):** taking AI output at face value with no catch; picking a giant brand and writing a vague history instead of a five-slot read; handing in a list of campaign tactics instead of finding the decision that breaks the rest (this is the exact mistake the chapter warns about); a buyer defined as "everyone."
>
...
- **The judgment-pass row is the one to double-check yourself.** It is worth the most and it is where the AI's own read can be too generous. If the student named and corrected a real AI error, that is a strong paper even if the map is rough. The grading guide says so too.
...
|---|---|---|
| **Judgment pass: knew vs. guessed** | 30 | Verifies two or more AI lines against the real brand; catches and corrects at least one line the AI guessed or invented |
| **The five-decision map** | 22 | All five decisions named and filled with specific, verified detail, not generic filler |
| **The decision that breaks the rest** | 20 | Names the one decision that would sink the other four (or two that contradict) and explains the knock-on |
| **Positioning and exchange** | 16 | One-line positioning names a real buyer and one benefit; shows why the trade is worth it to that buyer |
