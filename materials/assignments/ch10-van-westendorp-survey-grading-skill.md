...
>
> **Do not penalize** disclosed AI use; the AI step is required here. Only the absence of a real judgment pass (no code, no verification) is penalized, not the use of AI. If there is no AI transcript at all, the judgment pass cannot be verified; flag that for the instructor rather than awarding the row on faith.
>
> **Output format:**
